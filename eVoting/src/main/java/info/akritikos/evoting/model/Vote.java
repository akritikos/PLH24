...
public class Vote implements Serializable {
    ...
    public String toString() {
        return "info.akritikos.evoting.model.Vote[ pkVoteId=" + pkVoteId + " ]";
    }

    public Vote(boolean fldIsInvalid, boolean fldIsBlank, ElectoralPeriphery fkElectoralPeripheryId){
        this.fldIsInvalid = fldIsInvalid;
        this.fldIsBlank = fldIsBlank;
        this.fkElectoralPeripheryId = fkElectoralPeripheryId;
    }

    public Vote(PoliticalParty fkPoliticalPartyId, Candidate fkCandidateId, ElectoralPeriphery fkElectoralPeripheryId){
        fldIsBlank = false;
        fldIsInvalid = false;
        this.fkPoliticalPartyId = fkPoliticalPartyId;
        this.fkCandidateId = fkCandidateId;
